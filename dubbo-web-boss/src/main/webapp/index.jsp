...
<head>
    ...
    <title>用户统登录</title>
    <link href="<%=path%>/../../../statics/dwz/themes/css/login.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
...
<div id="login">
    ...
    <div id="login_content">
        <div class="loginForm">
            <form action="<%=path%>/login/userLogin" method="post">
                <p>
                    <label>用户名：</label>
                ...
                <p><br/><span class="info">${message}</span></p>
                <div class="login_bar" style="margin-left:10px;">
                    <input class="sub" type="submit" value="" />
                </div>
            </form>
        </div>
        <div class="login_banner"><img src="<%=path%>/statics/dwz/themes/default/images/login_banner.jpg" /></div>
